...
if __name__ == '__main__':
    ...
    from src.generated.generator import Generator
    ...
    class GeneratorWrapper(tf.keras.utils.Sequence):
        def __getitem__(self, item):
            ...
            # print(((res[0][0].shape, res[0][1].shape), (res[1][0].shape, res[1][1].shape, res[1][2].shape)))
            return res
    ...
    with generator:
        ...
        example = generator.__getitem__(0)
        print(example[0][0].shape, example[0][1].shape)
        print(example[1][0].shape, example[1][1].shape, example[1][2].shape)
